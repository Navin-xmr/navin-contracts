        ...
        match shipment_opt {
            Some(shipment) => {
                ...
                if !is_terminal {
                    ...
                    if shipment.deadline < current_timestamp && shipment.status == ShipmentStatus::InTransit {
                        if !anomalous_shipment_ids.contains(&id) {
                ...
                // Escrow tally
                sum_of_escrow_balances = sum_of_escrow_balances.saturating_add(shipment.escrow_amount as i128);
